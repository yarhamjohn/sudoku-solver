...
func TestSolveGrid(t *testing.T) {
	...
	t.Run("CompletesGridWith_FourEmptyBlocks_InTwoRows_InTwoColumns_InDifferentSquares", func(t *testing.T) {
		gridToTest := sudokuGrid{
	...
	t.Run("CompletesGridWith_FourEmptyBlocks_InTwoRows_InTwoColumns_InSameSquare", func(t *testing.T) {
		gridToTest := sudokuGrid{
